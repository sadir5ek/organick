...
//   // Check if 'products' is defined and has required properties
//   if (!products || !products.id) {
//     return <p>Продукт табылган жок</p>;
//   }

//   const [quantity, setQuantity] = useState(1); // State for quantity
//   const [activeTab, setActiveTab] = useState('description'); // Active tab for description/info
...
//       <div className="shopcard1">
//         <div className='frutss'>
//           <p className='Millets'>{products.name}</p>
//           <img src={products.img ? products.img : <p>No Image</p>} alt={products.name} />
//         </div>
...
//           <p className='stur'>⭐⭐⭐⭐⭐</p>
//           <div className="prise">
//             <p className='oldpris'>{products.price}</p>
